...
class BasicSection(object):
    ...
    def write_xlsx_rows(self, worksheet, start_row):
        ...
        BasicItem.write_xlsx_summary_row(
...
class BasicItem(object):
    ...
    def write_xlsx_row(self, worksheet, row):
        ...
        worksheet.cell(
            ...
            value="=1 - {}{}".format(get_column_letter(self.PERCENT_COL), row),
        )
    ...
    def __repr__(self):
        return (
            ...
            "percent={})".format(
                self.keyword, self.total_num, self.total_percent, self.num, self.percent
            )
        )
