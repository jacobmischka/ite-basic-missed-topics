...
def get_data_ranges(row_ranges):
    return [
        (start + 3, end - 1)  # padding, heading, subheading  # padding
...
def get_ranges(
    col, ranges, end_col=None, absolute_col=False, absolute_row=False, separator=","
):
    return separator.join(
        get_range_list(col, ranges, end_col, absolute_col, absolute_row)
    )
