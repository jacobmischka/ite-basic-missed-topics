...
class IteSection(object):
    ...
    def write_xlsx_rows(self, worksheet, start_row):
        ...
        IteItem.write_xlsx_summary_row(
            worksheet, subheading_row, subheading_row + 1, row - 1
        )
    ...
    def __repr__(self):
        return "IteSection(heading={}, subheading={}, items={})".format(
            self.heading, self.subheading, self.items
        )
...
class IteItem(object):
    ...
    A_OR_B_COL = 22
    CBY_DEFICIENT_COL = 23
    CA1_DEFICIENT_COL = 24
    CA2_DEFICIENT_COL = 25
    CA3_DEFICIENT_COL = 26
    ...
    def write_xlsx_row(self, worksheet, row):
        ...
        worksheet.cell(
            row=row,
            column=self.CBY_MISSED_COL,
            value="=1 - {}{}".format(get_column_letter(self.CBY_COL), row),
        )
        worksheet.cell(
            row=row,
            column=self.CA1_MISSED_COL,
            value="=1 - {}{}".format(get_column_letter(self.CA1_COL), row),
        )
        worksheet.cell(
            row=row,
            column=self.CA2_MISSED_COL,
            value="=1 - {}{}".format(get_column_letter(self.CA2_COL), row),
        )
        worksheet.cell(
            row=row,
            column=self.CA3_MISSED_COL,
            value="=1 - {}{}".format(get_column_letter(self.CA3_COL), row),
        )
